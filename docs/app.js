...
(function () {
  ...
  function aerialSlides(o) {
    ...
    return [19, 18, 17].map((z, i) => ({ type: "img", src: gsat(o, z), alt: esat(o, z), label: names[i] }));
  }
  ...
  function initMap() {
    ...
    const satLayer = L.tileLayer("https://{s}.google.com/vt/lyrs=s&x={x}&y={y}&z={z}",
      { attribution: "Imagery &copy; Google", maxZoom: 20, subdomains: ["mt0", "mt1", "mt2", "mt3"] });
    road.addTo(map);
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    $("#foot").innerHTML = "<b style='color:#C99A2E'>BUILD 13 — real satellite photos (Google) + media + scene colors</b> · hover to peek · click a photo to zoom (space/esc) · \u2605 & status save in your browser.";
  });
})();
